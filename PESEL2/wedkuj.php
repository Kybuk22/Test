...
<body>
    ...
    <div class=sredni>
        ...
        <div class='leww'><p>Ryby drapieżne naszych wód </p>
                <table class='tabble'>
                    <tr>
                        <th style="left:5.1%; position: absolute;border: 1px solid #4FB3DF;width:14%;">L.p.</th>
                        <th style="left:19.5%; position: absolute;border: 1px solid #4FB3DF;width:20%;">Gatunek</th>
                        <th style="left:39.9%; position: absolute;border: 1px solid #4FB3DF;width:28%;">Występowanie</th>
